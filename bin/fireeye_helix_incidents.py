...
import input_module_fireeye_helix_incidents as input_module
...
'''
    ...
    Add your modular input logic to file input_module_fireeye_helix_incidents.py
'''
class ModInputfireeye_helix_incidents(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputfireeye_helix_incidents, self).__init__("ta_fireeye_helix", "fireeye_helix_incidents", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputfireeye_helix_incidents, self).get_scheme()
        scheme.title = ("FireEye Helix: Incidents")
        scheme.description = ("Incidents generated in FireEye Helix.")
...
if __name__ == "__main__":
    exitcode = ModInputfireeye_helix_incidents().run(sys.argv)
    sys.exit(exitcode)
